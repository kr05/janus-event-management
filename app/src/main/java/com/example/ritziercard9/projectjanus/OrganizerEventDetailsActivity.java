...
public class OrganizerEventDetailsActivity extends AppCompatActivity {
    ...
    private TextView titleTextView, locationTextView, dateTextView, capacityTextView, soldTicketsTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soldTicketsTextView = findViewById(R.id.organizerEventDetailsSoldTickets);
    ...
    private void updateUI(Map<String, Object> data) {
        ...
        if (data.get("sold") != null) {
            soldTicketsTextView.setText(data.get("sold").toString());
        }
